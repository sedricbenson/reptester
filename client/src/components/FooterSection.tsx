      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#location" className="text-gray-400 hover:text-white transition duration-300">
                  Location
                </a>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-bold mb-6">Membership</h3>
            <ul className="space-y-3">
              <li>
                <a href="#pricing" className="text-gray-400 hover:text-white transition duration-300">
                  Dedicated Desk
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">319 Commercial Avenue, Anacortes, WA 98221</span>
              </li>
              <li className="flex items-start">
                <PhoneIcon className="h-5 w-5 mr-3 text-gray-400 mt-1" />
                <a href="tel:+13602991839" className="text-gray-400 hover:text-white transition duration-300">
                  360.299.1839
                </a>
              </li>
              <li className="flex items-start">
                <MailIcon className="h-5 w-5 mr-3 text-gray-400 mt-1" />
                <a href="mailto:heather@schussboomer.net" className="text-gray-400 hover:text-white transition duration-300">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center md:flex md:justify-between md:text-left">
          ...
          <div className="mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-white transition duration-300 mr-6">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-400 hover:text-white transition duration-300">
              Terms of Service
